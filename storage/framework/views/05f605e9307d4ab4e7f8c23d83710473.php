...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.forms.input.wrapper','data' => ['name' => ''.e($_name).'','label' => ''.e($label ?? 'Upload Image').'','required' => ''.e($required ?? false).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => ''.e($_name).'','label' => ''.e($label ?? 'Upload Image').'','required' => ''.e($required ?? false).'']); ?>
         <?php $__env->slot('label_top_right', null, []); ?> 
            Max. 2 MB
         <?php $__env->endSlot(); ?>
        <input type="file" name="<?php echo e($_name); ?>" class="<?php echo e($imageInputClass); ?>"
            ...
            <?php echo e($disabled ?? false ? 'disabled' : ''); ?> <?php echo e($multiple ?? false ? 'multiple' : ''); ?> />
