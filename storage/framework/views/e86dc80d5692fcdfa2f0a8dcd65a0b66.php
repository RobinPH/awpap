<div class="flex px-6 py-12 text-white bg-black sm:px-12 md:px-24 lg:px-48">
    <img src="<?php echo e(url('./assets/logowhite.png')); ?>" class="hidden w-36 h-36 md:block" />
    <div class="flex flex-wrap justify-between w-full lg:no-wrap">
        ...
        <div class="flex flex-col gap-2 p-3">
            ...
            <div class="flex flex-col gap-2 text-sm">
                <a href="<?php echo e(route('animal')); ?>">Animals</a>
                <a href="<?php echo e(route('about-us')); ?>">About Us</a>
                <a href="<?php echo e(route('join-us')); ?>">Join Us</a>
            </div>
        </div>
        <div class="flex flex-col gap-2 p-3">
            <div class="font-bold">Quick Links</div>
            <div class="flex flex-col gap-2 text-sm">
                <a href="<?php echo e(route('program')); ?>">Programs</a>
                <a href="<?php echo e(route('guideline')); ?>">Guidelines</a>
                <a href="<?php echo e(route('sign-up')); ?>">Sign Up</a>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\Users\Robin\Desktop\School\3rd year 2nd sem\SoftEng\awpap\resources\views/livewire/footer.blade.php ENDPATH**/ ?>