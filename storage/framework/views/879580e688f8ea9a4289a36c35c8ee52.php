...
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($name ?? null),'label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($label),'required' => ''.e($required ?? false).'']); ?>
    <input type="<?php echo e($type ?? 'text'); ?>" <?php if(isset($name)): ?> name="<?php echo e($name); ?>" <?php endif; ?>
        placeholder="<?php echo e($placeholder ?? ''); ?>" class="w-full input input-bordered"
        value="<?php echo e(isset($value) ? $value : ''); ?>" <?php echo e($required ?? false ? 'required' : ''); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Robin\Desktop\School\3rd year 2nd sem\SoftEng\awpap\resources\views/components/forms/input/text.blade.php ENDPATH**/ ?>