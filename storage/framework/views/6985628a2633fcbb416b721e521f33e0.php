...
} elseif ($_instance->childHasBeenRendered('k1bXEf0')) {
    $componentId = $_instance->getRenderedChildComponentId('k1bXEf0');
    $componentTag = $_instance->getRenderedChildComponentTagName('k1bXEf0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('k1bXEf0');
} else {
    $response = \Livewire\Livewire::mount('forms.input.address', ['address' => $user->address]);
    $html = $response->html();
    $_instance->logRenderedChild('k1bXEf0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

            <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.forms.input.image-upload','data' => ['id' => 'user-profile-picture-'.e($user->id).'','name' => 'image','image' => $user->profilePicture]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'user-profile-picture-'.e($user->id).'','name' => 'image','image' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user->profilePicture)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
